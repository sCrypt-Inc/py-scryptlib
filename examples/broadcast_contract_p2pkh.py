...
unlock_key_priv = PrivateKey.from_WIF('Kyfr5KmTikZU9zMYCTLAZPBNWRkvfi4PBskh51W2j7CbPKDmhGh2')
...
tx_input = TxInput(prev_tx_hash, prev_tx_out_idx, None, n_sequence)

tx_output_script = p2pkh_obj.locking_script
tx_output = TxOutput(out_satoshis, tx_output_script)
